...
class Buku extends CI_Controller
{
    ...
    public function hapusBuku()
    {
        ...
        $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-message" role="alert">Hapus Data Berhasil Dilakukan</div>');
        redirect('buku');
    }
}

/* End of file Buku.php and path \application\controllers\Buku.php */
